...
#         if i['tag'] == tag:
#             if tag == 'add_to_cart':
#                 item = i['patterns'][0].split('Add ')[1].split(' to cart')[0]
#                 cart.append(item)
#                 return i['responses'][0].format(item=item)
#             else:
#                 return random.choice(i['responses'])
#     return "Sorry, I didn't understand that. Can you please rephrase?"
...
#     cart.append(item)
#     return jsonify({"response": f"{item} has been added to your cart!"})
...
#02/08/24
#added general queries and feedback
...
# @app.route("/chat", methods=["POST"])
# def chat():
#     global general_query_mode, feedback_mode
...
# @app.route("/chat", methods=["POST"])
# def chat():
#     global general_query_mode, feedback_mode, store_near_me_mode
...
# def view_cart():
#     if cart:
#         cart_items = "<br>".join(cart)
#         return jsonify({"response": f"Your cart items:<br>{cart_items}"})
#     return jsonify({"response": "Your cart is empty."})
...
#     # Check if the store_near_me_mode is active
...
#same day added allow location notification in 3 type 
